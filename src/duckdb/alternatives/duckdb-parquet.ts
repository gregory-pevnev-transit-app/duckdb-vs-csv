...
async function main() {
  ...
  console.log('Copying', process.memoryUsage());

  await exportConn.run(`COPY ${TABLE_NAME} TO '${OUTPUT_FILE}' (FORMAT PARQUET, COMPRESSION zstd, COMPRESSION_LEVEL 3, ROW_GROUP_SIZE 10000000);`);
